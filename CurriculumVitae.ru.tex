...
\cvitem{Исследования}{
  Я делаю свои первые шаги в науке, и мне это чертовски нравится. В данный момент, я заинтересован в NLP системах и алгоритмах, в частности, в автоматическом построении тезаурусов.
}
